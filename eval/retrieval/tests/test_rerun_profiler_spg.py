"""Hermetic pins for eval/program/rerun_profiler_spg.py — M7 T1."""
...
_SCRIPT = _REPO_ROOT / "eval" / "program" / "rerun_profiler_spg.py"
...
def test_company_name_is_uppercase_spg_never_slug() -> None:
    ...
    assert "sp_company_name\"] = \"spg\"" not in source
