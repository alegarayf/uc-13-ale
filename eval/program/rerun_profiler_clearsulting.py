"""Re-run Company Profiler for Clearsulting on serverless (eval-signal-foldback M5 T1).
...
Usage (from repo root):
  python eval/program/rerun_profiler_clearsulting.py
"""
...
RUN_NAME = "m5-t1-profiler-clearsulting"
...
CLUSTER_DRIVER = '''\
"""Clearsulting Company Profiler re-run — cluster driver (M5 T1)."""
from __future__ import annotations
...
def _upload_driver(w: WorkspaceClient, user: str, source: str) -> str:
    driver_path = f"/Users/{user}/rerun_profiler_clearsulting_driver.py"
